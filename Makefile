...
# These definitions are from config.sh (via /usr/local/lib/perl5/5.10.0/x86_64-linux/Config.pm).
...
OBJ_EXT = .o
OSNAME = linux
OSVERS = 2.6.23.15-137.fc8
RANLIB = :
SITELIBEXP = /usr/local/lib/perl5/site_perl/5.10.0
SITEARCHEXP = /usr/local/lib/perl5/site_perl/5.10.0/x86_64-linux
SO = so
VENDORARCHEXP = 
VENDORLIBEXP = 
...
INSTALLARCHLIB = /usr/local/lib/perl5/5.10.0/x86_64-linux
DESTINSTALLARCHLIB = $(DESTDIR)$(INSTALLARCHLIB)
INSTALLSITEARCH = /usr/local/lib/perl5/site_perl/5.10.0/x86_64-linux
...
PERL_LIB =
PERL_ARCHLIB = /usr/local/lib/perl5/5.10.0/x86_64-linux
LIBPERL_A = libperl.a
FIRST_MAKEFILE = Makefile
MAKEFILE_OLD = Makefile.old
MAKE_APERL_FILE = Makefile.aperl
PERLMAINCC = $(CC)
PERL_INC = /usr/local/lib/perl5/5.10.0/x86_64-linux/CORE
...
O_FILES  = 
H_FILES  = 
MAN1PODS = script/flyhalf_cgi.pl \
	script/flyhalf_create.pl \
	script/flyhalf_fastcgi.pl \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=1 --perm_rw=$(PERM_RW) \
	  ...
	  script/flyhalf_server.pl $(INST_MAN1DIR)/flyhalf_server.pl.$(MAN1EXT) \
...
EXE_FILES = script/flyhalf_cgi.pl script/flyhalf_create.pl script/flyhalf_fastcgi.pl script/flyhalf_server.pl script/flyhalf_test.pl

pure_all :: $(INST_SCRIPT)/flyhalf_fastcgi.pl $(INST_SCRIPT)/flyhalf_test.pl $(INST_SCRIPT)/flyhalf_server.pl $(INST_SCRIPT)/flyhalf_create.pl $(INST_SCRIPT)/flyhalf_cgi.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/flyhalf_fastcgi.pl $(INST_SCRIPT)/flyhalf_test.pl \
	  $(INST_SCRIPT)/flyhalf_server.pl $(INST_SCRIPT)/flyhalf_create.pl \
	  $(INST_SCRIPT)/flyhalf_cgi.pl 

$(INST_SCRIPT)/flyhalf_fastcgi.pl : script/flyhalf_fastcgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/flyhalf_fastcgi.pl
	$(CP) script/flyhalf_fastcgi.pl $(INST_SCRIPT)/flyhalf_fastcgi.pl
	$(FIXIN) $(INST_SCRIPT)/flyhalf_fastcgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/flyhalf_fastcgi.pl

$(INST_SCRIPT)/flyhalf_test.pl : script/flyhalf_test.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/flyhalf_test.pl
	$(CP) script/flyhalf_test.pl $(INST_SCRIPT)/flyhalf_test.pl
	$(FIXIN) $(INST_SCRIPT)/flyhalf_test.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/flyhalf_test.pl

$(INST_SCRIPT)/flyhalf_server.pl : script/flyhalf_server.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/flyhalf_server.pl
	$(CP) script/flyhalf_server.pl $(INST_SCRIPT)/flyhalf_server.pl
	$(FIXIN) $(INST_SCRIPT)/flyhalf_server.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/flyhalf_server.pl

$(INST_SCRIPT)/flyhalf_create.pl : script/flyhalf_create.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/flyhalf_create.pl
	$(CP) script/flyhalf_create.pl $(INST_SCRIPT)/flyhalf_create.pl
	$(FIXIN) $(INST_SCRIPT)/flyhalf_create.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/flyhalf_create.pl

$(INST_SCRIPT)/flyhalf_cgi.pl : script/flyhalf_cgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/flyhalf_cgi.pl
	$(CP) script/flyhalf_cgi.pl $(INST_SCRIPT)/flyhalf_cgi.pl
	$(FIXIN) $(INST_SCRIPT)/flyhalf_cgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/flyhalf_cgi.pl
...
catalyst_par :: all
	$(NOECHO) $(PERL) -Ilib -Minc::Module::Install -MModule::Install::Catalyst -e"Catalyst::Module::Install::_catalyst_par( '', 'FlyHalf', { CLASSES => [], PAROPTS =>  {}, ENGINE => 'CGI', SCRIPT => '', USAGE => q## } )"
